## Title: trendy_climate dswrf,rsds for S0
## Date:2018-08-23
...
## set workspace
ori_dir <- setwd("S:/hao_shi/gcp18/trendyv7/clim/dswrf/")
...
## create netcdf
nc_file <- "E:\\Trendy_2018\\DLEM_S0_rsds.nc" ## note: set up the path for nc_file
...
## for s0, s1, s4
pre_s_daily_1700 <- readDlemDailyBin("dswrf1700.bin")
